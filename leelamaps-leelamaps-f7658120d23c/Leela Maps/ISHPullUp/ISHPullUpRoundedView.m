...
- (void)setupDefaultValues {
    ...
    [self setStrokeColor:[UIColor opaqueSeparatorColor]];//lightGrayColor]];
...
- (void)setupDefaultValues {
    self.visualEffectsView = [[UIVisualEffectView alloc] initWithEffect:[UIBlurEffect effectWithStyle:UIBlurEffectStyleProminent]];
